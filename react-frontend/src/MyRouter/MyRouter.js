...
import SingleFrameworkPage from "../components/FrameworkPage/SingleFrameworkPage";
import FrameworkProjectLayoutPage from "../components/FrameworkPage/FrameworkProjectLayoutPage";
import SingleSecframeworkPage from "../components/SecframeworkPage/SingleSecframeworkPage";
import SecframeworkProjectLayoutPage from "../components/SecframeworkPage/SecframeworkProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/framework/:singleFrameworkId" exact element={<SingleFrameworkPage />} />
<Route path="/framework" exact element={<FrameworkProjectLayoutPage />} />
<Route path="/secframework/:singleSecframeworkId" exact element={<SingleSecframeworkPage />} />
<Route path="/secframework" exact element={<SecframeworkProjectLayoutPage />} />
