...
import SecframeworkPage from "../SecframeworkPage/SecframeworkPage";
// ~cb-add-import~
...
<li
                onClick={() => {
                  setCurrentActiveTab2("framework");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "framework",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "framework" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "framework",
                      "text-black": props?.currentActiveTab2 !== "framework",
                    })}
                  >
                  Framework
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "framework",
                      "text-yellow-700": props?.currentActiveTab2 !== "framework",
                    })}
                  >
...
<li
                onClick={() => {
                  setCurrentActiveTab2("secframework");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "secframework",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "secframework" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "secframework",
                      "text-black": props?.currentActiveTab2 !== "secframework",
                    })}
                  >
                  Secframework
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "secframework",
                      "text-yellow-700": props?.currentActiveTab2 !== "secframework",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
